        ...
        >
          ...
          <div className="location-search-input-wrapper">
            <Combobox.Input
              ...
              className="location-search-input w-full h-[45px] md:h-[50px] !mb-0 text-dark inline-flex items-center top-0 text-sm ring-offset-background transition-colors focus-visible:outline-none  disabled:pointer-events-none disabled:opacity-50 bg-background hover:bg-accent px-4 py-2 justify-start  font-medium bg-white  hover:bg-white hover:text-muted-foreground lg:hover:bg-accent lg:hover:text-accent-foreground transition-none z-10 rounded-sm"
